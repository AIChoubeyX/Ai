...
// import Particles from "./Particles"; // Assuming same component
...
//               <path fillRule="evenodd" clipRule="evenodd" d="M4.555.72..." fill="#6c63ff" />
//             </svg>
//           </div>
...
//         <div className="flex items-center gap-1">
//           <span>Posted on</span>
//           <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#6c63ff]">
//             <svg width="11" height="10" viewBox="0 0 11 10" fill="none">
//               <path d="m.027 0 4.247..." fill="currentColor" />
//             </svg>
//           </a>
//         </div>
//         <p>{card.date}</p>
...
//   return (
//     <div className="relative bg-black w-full py-16 overflow-hidden">
...
//       {/* Foreground testimonial rows */}
//       <div className="relative z-10 marquee-row w-full mx-auto max-w-7xl overflow-hidden">
