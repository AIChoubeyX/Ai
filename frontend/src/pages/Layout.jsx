  ...
  return user ? (
    <div className="flex flex-col items-start justify-start h-screen bg-gray-900">
      ...
      <nav className="w-full px-4 sm:px-8 min-h-14 flex items-center justify-between border-b border-gray-700 bg-gray-800/90 backdrop-blur-sm">
        ...
        {/* CHANGED: Added horizontal margin for mobile breathing room - mx-2 sm:mx-0 */}
        <div className="flex flex-1 justify-center items-center mx-2 sm:mx-0">
          {/* CHANGED: Reduced right margin on mobile from mr-5 to mr-2 sm:mr-3 */}
          <span className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-gray-200 mr-2 sm:mr-3 md:mr-4 lg:mr-5">
            Empowering Ideas with AI
          </span>
        ...
        {/* CHANGED: Added left margin for mobile spacing - ml-3 sm:ml-0 */}
